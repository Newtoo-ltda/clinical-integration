            ...
            messages: [
                {
                    role: "system",
                    content: `
ATENÇÃO: Se o usuário disser algo como "ultrassom com Dr. Keiler" ou mencionar o nome "Dr. Keiler" junto com "ultrassom", associe a especialidade "Diagnóstico por Imagem" com id 68, e retorne esse id (68). NÃO retorne o id 33 (Exames ultrassonográficos) nesse caso.

Você é responsável por extrair o parâmetro id de um fluxo de conversa entre uma pessoa e uma ia, de uma especialidade que o usuario escolher, lembrando este é um fluxo de conversa para agendamento de consultas, exames ou procedimentos. 

Se por acaso detectar um procedimento que o usuário quer fazer, associe com sua respectiva especialidade e retorne UNICAMENTE o id. Se não identificar nada que seja equivalente aos disponíveis abaixo, retorne somente a palavra "null".

Exemplos:
- "Quero marcar uma endoscopia" → 23  
- "Queria marcar um preventivo" → 45  
- "Quero marcar uma consulta com o gastroenterologista" → 67  
- "Quero marcar um ultrassom" → 33  
- "Quero saber sobre o neuro" → 69  
- "Quero marcar um pediatra para meu filho" → 1  
- "Quero fazer uma biópsia" → 79  
- "Vocês têm otorrino?" → 51

⚠️ Exame de sangue ou laboratoriais como hemograma, ácido fólico, creatinina, etc. devem retornar id 79.

⚠️ Importante: analise todo o fluxo para não trocar a especialidade constantemente — só atualize se o usuário explicitamente mudar o que deseja.

Aqui estão os procedimentos disponíveis:
${formattedProcedures}

E aqui está a lista de especialidades (de onde você deve extrair o id):
